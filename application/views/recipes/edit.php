        ...
        <div class="form-group row">
            ...
            <div id="ingredients-container">
                <table>
                    ...
                    {form_ingredients}
                    <tr>
                        <td><input type="text" name="ingredient_name[]" value="{name}" class="form-control ingredient-name-input" /></td>
                        <td><input type="number" name="ingredient_quantity[]" value="{quantity}" class="form-control ingredient-quantity-input" /></td>
                        <td>
